# Generated by Django 6.0.7 on 2026-07-16 07:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True)),
                ('status', models.CharField(choices=[('new', 'Новая'), ('in_progress', 'В процессе'), ('done', 'Выполнена')], default='new', max_length=20)),
                ...
                ('stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='core.stage')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('deadline_set', 'Дедлайн установлен'), ('deadline_soon', 'Дедлайн приближается'), ('deadline_overdue', 'Дедлайн просрочен')], max_length=20)),
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='discussions', to='core.task'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
        ...
        migrations.AlterUniqueTogether(
            name='notification',
            unique_together={('task', 'recipient', 'type')},
        ),
    ]
