...
urlpatterns = [
    ...
    path('ops/notifications/', views.outbound_queue, name='outbound_queue'),
    path('ops/notifications/<int:message_id>/retry/', views.outbound_retry, name='outbound_retry'),
    path('ops/notifications/<int:message_id>/cancel/', views.outbound_cancel, name='outbound_cancel'),
